...
namespace Sell.Data.Migrations
{
    ...
    [Migration("20200226142036_migcategory")]
            ...
            modelBuilder.Entity("Sell.Core.Domain.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreateOn = new DateTime(2020, 2, 26, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "دسته",
                            UpdateOn = new DateTime(2020, 2, 26, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
