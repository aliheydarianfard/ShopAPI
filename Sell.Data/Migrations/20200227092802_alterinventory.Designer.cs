...
namespace Sell.Data.Migrations
{
    ...
    [Migration("20200227092802_alterinventory")]
    partial class alterinventory
    {
            ...
            modelBuilder.Entity("Sell.Core.Domain.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreateOn = new DateTime(2020, 2, 27, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "دسته",
                            UpdateOn = new DateTime(2020, 2, 27, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
